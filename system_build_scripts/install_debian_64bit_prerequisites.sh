...
mkdir /opt/sw/64bit/debian/modules/3.2.9c/Modules/3.2.9/modulefiles/python
...
../configure --prefix=/opt/sw/64bit/debian/wxpython/2.8.12.1 \
             --with-gtk \
             --with-gnomeprint \
             --with-opengl \
             --enable-debug \
...
cat > /opt/sw/64bit/debian/modules/3.2.9c/Modules/3.2.9/modulefiles/wxpython/2.8.12.1 <<EOF
#%Module1.0#####################################################################

module-whatis "wx 2.8.12.1-i686"

prepend-path PATH               /opt/sw/64bit/debian/wxpython/2.8.12.1/bin
prepend-path LD_LIBRARY_PATH    /opt/sw/64bit/debian/wxpython/2.8.12.1/lib
EOF
