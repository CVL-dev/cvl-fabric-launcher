...
cd modules-3.2.9
./configure --prefix=/opt/sw/32bit/centos/modules/3.2.9c --with-tcl-lib=/usr/lib64 --with-tcl-inc=/usr/include
make
make install
echo ". /opt/sw/32bit/centos/modules/3.2.9c/Modules/3.2.9/init/bash" >> /etc/bash.bashrc
cd ..
