...
wget http://aarnet.dl.sourceforge.net/project/modules/Modules/modules-3.2.9/modules-3.2.9c.tar.gz
wget http://aarnet.dl.sourceforge.net/wxpython/wxPython-src-2.8.12.1.tar.bz2
